...
// fast endpoints (no heavy imports here)
app.get('/health', (req, res) => res.type('text').send('OK'));
app.get('/diag', async (req, res) => {
  // lazy check of chromium path without importing it unless we need it
  try {
...
// PNG endpoint — LAZY import heavy modules **inside** the handler
